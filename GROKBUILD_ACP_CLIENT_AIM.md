...
This file sits at the repository root on `main`. Read it before
`AGENTS.md` campaign notes, 4C runbooks, or `docs/OUTSTANDING.md`.
Those are evidence. This is the product contract.
...
Campaign ledger: [`docs/OUTSTANDING.md`](docs/OUTSTANDING.md).
