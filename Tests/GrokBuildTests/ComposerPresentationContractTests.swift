...
final class ComposerPresentationContractTests: XCTestCase {
    ...
    func testCampaignComputerUseSurfacesKeepStableIdentifiers() throws {
        ...
        XCTAssertFalse(contentView.contains("private struct UpdatesBanner"))
        XCTAssertTrue(sidebar.contains("accessibilityIdentifier(\"grok-upgrade-indicator\")"))
        XCTAssertTrue(sidebar.contains("Button(\"Open Updates\""))
        XCTAssertTrue(sidebar.contains("Button(\"Dismiss until next launch\""))
