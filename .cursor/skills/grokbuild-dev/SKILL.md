...
| Slice 4C locked paid matrix | `python3 -m unittest scripts.acceptance.tests.test_4c_paid_lock`; `swift test --filter AcceptanceHarnessTests/testSlice4C`. Ceiling stays unconditional; `require_4c_unlock_predicate` is unwired. |
