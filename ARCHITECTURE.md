...
| File | Role |
|------|------|
| `AppTheme.swift` | Cool-neutral canvas, typography, layout widths, radii, warning/link tokens, and reusable matte surface |
