...
| File | Role |
|------|------|
| `AppTheme.swift` | Cool-neutral canvas, typography, layout widths, radii, warning/link tokens, reusable matte surface, and `TitlebarGlyph` / `titlebarControl` so transparent-titlebar icons stay readable on Dark |
